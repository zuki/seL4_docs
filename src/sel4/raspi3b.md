...
> **訳注**: 64ビット版の実行例については[Tim Retout市のブログ](https://retout.co.uk/2020/05/11/sel4-on-rpi3-aarch64/)を参照。
...
>   **訳注**: 2023年6月2日現在、masterブランチでは割り込み定義がraspi3対応になっておらず実行できない。
>             実行できる最新版はv12.1.0
...
# ../init-build.sh -DPLATFORM=rpi3 -DAARCH64=1      // 64ビット版の初期化
...
bootelf 0x10000000
# go 0x10000000             // 64ビット版はelfではなくbinaryなので実行コマンドが違う
```
